 ...
 *
 * @template T enforce a type on all properties that are defined and not `Metadata`.
 */
export interface Collection<T extends Model> extends Dictionary<T | Metadata | undefined | null> {
	_metadata?: Metadata
}
