...
function fetchData(action) {
	var baseConfig, headers, fetchConfig, store, tryLimit, tryCount, didFail, didTimeOut, lastError, oauthToken, _ref, fetchResult, timedOut;
...
function fetchSaga(modelsParam, apiRootParam) {
	...
	var errorParam = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : errorPerform;
