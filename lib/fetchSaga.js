...
function fetchData(action) {
	var baseConfig, headers, fetchConfig, isUrlValid, store, tryLimit, tryCount, didFail, didTimeOut, lastError, oauthToken, _ref, fetchResult, timedOut, errorObject, _errorObject, _errorObject2, _fetchResult;
		...
		while (1) {
			switch (_context.prev = _context.next) {
				...
				case 15:
					...
					if (/{:.+}/.test(fetchConfig.path)) {
						fetchConfig.path = fetchConfig.path.replace(/{:(.+?)}/, function (matches, backref) {
							var value = fetchConfig.routeParams[backref];
