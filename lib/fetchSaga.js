...
var _marked = [fetchData, fetchOnce, fetchDataLoop, fetchDataRecurring, fetchLatest, interceptOauthToken, fetchSaga].map(regeneratorRuntime.mark);
...
function fetchOnce(action) {
	return regeneratorRuntime.wrap(function fetchOnce$(_context2) {
		while (1) {
...
function fetchDataLoop(config) {
	return regeneratorRuntime.wrap(function fetchDataLoop$(_context3) {
		while (1) {
...
function fetchDataRecurring(config) {
	var bgSyncTask;
	return regeneratorRuntime.wrap(function fetchDataRecurring$(_context4) {
		while (1) {
...
function fetchLatest(config) {
	return regeneratorRuntime.wrap(function fetchLatest$(_context5) {
		while (1) {
...
function interceptOauthToken(action) {
	return regeneratorRuntime.wrap(function interceptOauthToken$(_context6) {
		while (1) {
...
function fetchSaga(modelsParam, apiRootParam, loggerParam) {
	return regeneratorRuntime.wrap(function fetchSaga$(_context7) {
		while (1) {
