		...
		while (1) {
			switch (_context3.prev = _context3.next) {
				...
				case 8:
					_context3.prev = 8;
					_context3.next = 11;
					return (0, _effects.put)(_actions2.default.PERIODIC_TERMINATION_SUCCEEDED);
			...
			switch (_context4.prev = _context4.next) {
				...
				case 6:
					...
					return (0, _effects.take)(function (incomingAction) {
						return incomingAction.type === _actions2.default.PERIODIC_TERMINATION_REQUESTED && incomingAction.taskId === action.taskId;
					});
