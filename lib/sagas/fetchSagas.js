...
var _marked = [fetchData, fetchOnce, fetchDataLoop, fetchDataRecurring, fetchLatest, interceptOauthToken, fetch].map(_regenerator2.default.mark);
...
function fetchData(action) {
  var tryLimit, tryCount, didFail, lastError, baseConfig, authHeaders, headers, fetchConfig, _ref, fetchResult, timedOut;
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        ...
        case 11:
          ...
          baseConfig = Object.byString(models, action.modelName);
        ...
        case 14:
          ...
          return (0, _effects.race)({
            fetchResult: (0, _effects.call)(_services.doFetch, fetchConfig),
        ...
        case 30:
          ...
          _context.next = 33;
          return (0, _effects.put)((0, _actions.createAction)(_actions2.default.FETCH_TIMED_OUT, { modelName: action.modelName }));
        ...
        case 35:
          _context.next = 37;
          return (0, _effects.put)((0, _actions.createAction)(_actions2.default.FETCH_TRY_FAILED, { modelName: action.modelName, errorData: fetchResult }));
...
function fetch(modelsParam, apiRootParam) {
  var loggerParam = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : { log: function log(error) {
      console.log(error);
    } };
  return _regenerator2.default.wrap(function fetch$(_context7) {
    while (1) {
      switch (_context7.prev = _context7.next) {
        ...
        case 2:
          (0, _services.setApiRoot)(apiRootParam);
          logger = loggerParam;
          models = modelsParam;
