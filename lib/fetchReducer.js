...
function fetchReducer() {
	...
	switch (action.type) {
		case _get__('actions').FETCH_REQUESTED:
			...
			return _get__('_').merge({}, state, newState);
		...
		case _get__('actions').FETCH_RESULT_RECEIVED:
			...
			return _get__('_').merge({}, _get__('_').omit(state, path), newState);
		...
		case _get__('actions').KEY_REMOVAL_REQUESTED:
			return _get__('_').omit(state, modelName);
